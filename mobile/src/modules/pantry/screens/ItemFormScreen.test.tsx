...
describe('ItemFormScreen', () => {
  ...
  it('warns when the barcode scan finds no barcode', async () => {
    ...
    expect(
      await screen.findByText("Couldn't recognize a barcode in the photo, try again or enter it manually."),
    ).toBeTruthy();
  ...
  it('does not warn when the barcode scan camera is cancelled', async () => {
    ...
    expect(
      screen.queryByText("Couldn't recognize a barcode in the photo, try again or enter it manually."),
    ).toBeNull();
  });
  ...
  it('warns when the OCR scan finds no date', async () => {
    ...
    expect(
      await screen.findByText("Couldn't recognize an expiry date in the photo, you can enter it manually."),
    ).toBeTruthy();
  });
